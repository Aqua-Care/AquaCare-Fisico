...
#define WIFI_SSID "Irineuvcnaosabenemeu"
#define WIFI_PASSWORD "eunaosei"

// For the following credentials, see examples/Authentications/SignInAsUser/EmailPassword/EmailPassword.ino

/* 2. Define the API Key */
#define API_KEY "AIzaSyCL9pwtrL5AkaYLCOYgv0z88o38Xv2g5cY"

/* 3. Define the RTDB URL */
#define DATABASE_URL "esp8266-a784c-default-rtdb.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "zugscorp@gmail.com"
#define USER_PASSWORD "zugsesport"
...
void loop()
{
  ...
  if (Firebase.ready() && (millis() - sendDataPrevMillis > 15000 || sendDataPrevMillis == 0))
  {
    ...
    Serial.printf("Set string... %s\n", Firebase.RTDB.setString(&fbdo, F("/test/string"), F("PICA GROSSONA DOUGLAS ME MACETA")) ? "ok" : fbdo.errorReason().c_str());
